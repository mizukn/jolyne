...
// 2 they have to buy food supplies for the celebration (use the shop command to buy food items) and give them to Mista (/quests action command quest)
// 3 they have to send invitations (/quests action command quest again)
...
2. Buy food supplies for the celebration using the /shop command, and give them to me using the /quests action command!
3. Send out invitations using the /quests action command again!
