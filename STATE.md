...
- **P3.4 fat command files** — 🟡 `RaidSubcommands.ts` down to 791 lines after extracting `src/rpg/SeasonalRaids.ts` (seasonal raid boss definitions + `getFixedBosses`). `Dungeon.ts` (829 lines) still untouched.
